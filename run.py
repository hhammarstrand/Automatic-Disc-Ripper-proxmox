#!/usr/bin/env python3
"""Automatic Disc Ripper for Proxmox – Entry point.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Automatic Disc Ripper for Proxmox")
    ...
    logger.info("=" * 60)
    logger.info("Automatic Disc Ripper for Proxmox v1.0.0 starting")
    logger.info("=" * 60)
    ...
    try:
        ...
        pipeline.stop()
        logger.info("Automatic Disc Ripper for Proxmox stopped")
